...
$ID = $_GET['id'];
$sql = "SELECT * FROM kategorie LEFT JOIN subkategorie ON subkategorie.Id_kat=kategorie.Id_kategorie WHERE Id_kategorie = '$ID'";
...
if(isset($_POST['update']) && $_POST['update'] == 1) {
    ...
    $dotaz2 = "UPDATE kategorie SET nazev ='" . $NAZEV . "' WHERE Id_kategorie = '". $ID."'";
    if ($NAZEV == "") {
