...
?>
    <table>
        <tbody>
        <tr style="">
            <td funny_nadpis="id_produkt"><?php echo $row['id_produkt']; ?></td>
            <td funny_nadpis="jmeno_produkt"><?php echo $row['jmeno_produktu']; ?></td>
            <td funny_nadpis="jmeno_produkt"><?php echo $row['cena']; ?></td>
            <?php echo"
            <td funny_nadpis='jmeno_produkt'><a href='mazani_produktu.php?id_produkt=$id_produkt'><strong>Smazat</strong></a>
            ";?>
            </td>
        </tr>
        </tbody>
