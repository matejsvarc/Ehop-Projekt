...
if(isset($_POST['update']) && $_POST['update'] == 1) {
    ...
    $dotaz2 = "UPDATE forum_kategorie SET popis ='" . $NAZEV . "' WHERE id_kategorie = '". $ID."'";
    if ($NAZEV == "") {
...
<form method="post" action="">
    ...
    <label>Zmena Popisu</label>
    <p><input type="text" name="nazev" placeholder="Zadejte novy nazev" value="<?php echo $radek['popis'];?>" required></p>
