...
<section class="products">
    ...
    <?php
    $select_products = mysqli_query($conn, "SELECT * FROM produkty WHERE Id_kategorie = 29   ORDER BY id_produkt ASC");
    ...
    <form action="" method="post">
        <div class="section-products">
            <div id='product-1' class='single-product'>
                ...
                <div class='part-2'>
                    <img class="product-image" src="images/<?php echo $fetch_product['obrazek']; ?>" alt="">
                    <h3><?php echo $fetch_product['jmeno_produktu']; ?></h3>
